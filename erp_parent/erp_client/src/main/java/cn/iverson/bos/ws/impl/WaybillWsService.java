 ...
 * 
 */
@WebServiceClient(name = "WaybillWsService", targetNamespace = "http://impl.ws.bos.iverson.cn/", wsdlLocation = "http://localhost:9090/ws/waybill?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WAYBILLWSSERVICE_QNAME = new QName("http://impl.ws.bos.iverson.cn/", "WaybillWsService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9090/ws/waybill?wsdl");
    ...
    public IWaybillWs getWaybillWsPort() {
        return super.getPort(new QName("http://impl.ws.bos.iverson.cn/", "WaybillWsPort"), IWaybillWs.class);
    }
    ...
    public IWaybillWs getWaybillWsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.ws.bos.iverson.cn/", "WaybillWsPort"), IWaybillWs.class, features);
    }
