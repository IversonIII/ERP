 ...
 * generated in the cn.iverson.bos.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _AddWaybillResponse_QNAME = new QName("http://ws.bos.iverson.cn/", "addWaybillResponse");
    private final static QName _WaybilldetailList_QNAME = new QName("http://ws.bos.iverson.cn/", "waybilldetailList");
    private final static QName _AddWaybill_QNAME = new QName("http://ws.bos.iverson.cn/", "addWaybill");
    private final static QName _WaybilldetailListResponse_QNAME = new QName("http://ws.bos.iverson.cn/", "waybilldetailListResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.iverson.bos.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.bos.iverson.cn/", name = "addWaybillResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.bos.iverson.cn/", name = "waybilldetailList")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.bos.iverson.cn/", name = "addWaybill")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.bos.iverson.cn/", name = "waybilldetailListResponse")
